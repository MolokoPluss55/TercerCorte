...
function preload(){
	 table = loadTable("data/aire.csv", "header");
  nube = loadModel('assets/miNube.obj', true);
  fuente = loadFont('fuentes/Proxima_Nova_Bold.otf');
}

function setup() {
	var miCanvas = createCanvas(820,600, WEBGL);
  miCanvas.parent("fontibonCont");
